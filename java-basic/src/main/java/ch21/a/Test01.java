...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // => JVM이 발생시키는 예외
    // => 애플리케이션에서 처리할 수 없다.
    // => 애플리케이션의 현재 작업 결과를 적절히 저장한 후 즉시 종료해야한다.
    // => Error 계열의 예외이다.
    //    java.lang.Object
    ...
    // => JVM이 멈추기 전에 현재까지 작업한 것을 저장하고 싶다면, 예외처리를 해야한다.
...
//  System.out.println(sum(100000)); //StackOverflowError
    ...
    // => 실행을 멈추지 않게 하려면 애플리케이션 예외가 발생했을 때 적절히 조치를 취해야한다.
    // => Exception 계열의 예외이다.
    //    java.lang.Object
    //       ㄴ> java.lang.Throwable
    ...
    //      IOException, SQLException, ClassNotLoadedException
