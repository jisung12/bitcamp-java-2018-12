...
public class Test08 {
  public static void main(String[] args) {
    ...
    // Object로부터 상속 받은 equals()가 원래는 인스턴스가 같은 지를 비교한다고 했는데,
    // 왜 String 클래스는 인스턴스가 아닌 문자열 값을 비교하나?
    //  => String 클래스는 상속 받은 equals를 재정의하였기 때문이다.
    //   => 이렇게 상속받은 기능을 자신의 역할에 맞게끔 재정의하는 것을 "오버라이딩(overriding)"이라 한다.
    //
    // StringBuffer는 재정의 하지 않아서 다르다고 결과가 나온것인가?
    // => yes! 
  } 
}
