...
public class Score2 {
  // name은 직접 접근해도 되지만 다른 필드와 일관성을 위해 직접 접근을 막고 getter/setter 사용.
  // 이렇게하면 나중에 name에 대해 값의 유효성을 검사하는 코드를 즉시 삽입할 수 있으니까
  // 유지보수에도 도움이 된다.
  ...
  // setter에서 유효성을 검사하지 않더라도 그냥 만들어라!
  private String name;
 ...
 public void setName(String name) {
  ...
  // 따라서 비공개로 만든다.
  // 초보 개발자의 많은 착각 : 필드는 무조건 private, 메서드는 무조건 public으로 해야한다는 생각한다.
  //           => 필드든 메서드든 공개할 것은 공개하고 공개하지 말아야하는 것은 공개하면 안된다.
  //           => 기본이 비공개이고 공개할 것만 공개!
