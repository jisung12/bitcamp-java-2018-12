  ...
  public static void main(String[] args) {
    try( Scanner keyboard = new Scanner(System.in);
      ...
      try(
          ...
          // - 대기열에 클라이언트 정보가 없다면 있을 때까지 기다린다.
          //   즉  blocking 모드로 작동한다.
        ...
        // 따라서 서버는 한 줄의 문자열을 읽은 후가에 응답해야 한다.
        
        // 서버에서 한 줄의 데이터를 읽기 전에는 클라이언트의 write() 리턴하지 않음을 
        ...
        // 한 줄의 문자열? 문자열 끝에 줄바꿈 코드(Line Feed; 0x0A)를 만날 때까지  
