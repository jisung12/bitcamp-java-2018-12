...
public class Score3 implements Serializable {
  ...
  // Test3_1을 실행하여 scroe3.data 파일에 인스턴스를 출력한 후
  ...
  // Test3_1을 실행하여 scroe3.data 파일에 인스턴스를 출력한 후
  // tel 필드를 추가하고 getter/setter를 추가한다.
