...
public class Test08 {
  ...
  public static void main(String[] args) {
    ...
    // new int[3] : int 변수 3개 생성한다. 각 항목에 저장하는 값은 int.
    ...
    //* new Scores[3] : Score 레퍼런스 3개를 생성한다. 주의! 인스턴스를 생성하는 것이 아니다.
    // *인스턴스 배열을 만들 수 있는 방법은 없다!
    ...
    // 인스턴스 배열을 만들 수 없다.
    // 레퍼런스 배열은 만들 수 있다.
    // 단 자바 기본타입(byte ~ char)은 해당 타입의 메모리를 배열로 만들 수 있다.
    // 그 외 모든 타입은 오직 레퍼런스 배열만 생성한
