...
public class Canvas {
  ...
  //    매우 편리하다. 어떤 클래스를 상속받든 단지 Pen이라는 규칙만 따르면 되기 때문이다.
  // Monami tool;
