...
<c:otherwise>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="date" name='startDate' class="form-control-plaintext" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="date" name='endDate'  class="form-control-plaintext" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="number" name='totalHours'  class="form-control-plaintext" 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="number" name='dayHours'  class="form-control-plaintext" 
