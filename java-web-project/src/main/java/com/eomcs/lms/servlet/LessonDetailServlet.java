...
public class LessonDetailServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println(String.format(
        "<tr> <th>수업명</th> <td><input type='text' name='title' value='%s'></td> </tr>", lesson.getTitle()));
    out.println(String.format(
    ...
    out.println(String.format(
        "<tr> <th>총수업시간</th> <td><input type='number' name='totalhour' value='%d'></td> </tr>", lesson.getTotalHours()));
    out.println(String.format(
        "<tr> <th>일수업시간</th> <td><input type='number' name='dayhour' value='%d'></td> </tr>", lesson.getDayHours()));
    out.println("</table>");
